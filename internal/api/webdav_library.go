...
func (s *Server) handleLibraryGETHEAD(w http.ResponseWriter, r *http.Request) {
	...
	if mr == nil {
		...
		_ = st.StreamRange(r.Context(), n.Entry.ImportID, n.Entry.FileIdx, n.Entry.Filename, 0, sz-1, w, prefetchForSizeSubject(sz, n.Entry.Subject))
		return
	}
	if len(mr.Ranges) != 1 {
		w.WriteHeader(http.StatusRequestedRangeNotSatisfiable)
	...
	_ = st.StreamRange(r.Context(), n.Entry.ImportID, n.Entry.FileIdx, n.Entry.Filename, br.Start, br.End, w, prefetchForSizeSubject(sz, n.Entry.Subject))
}
